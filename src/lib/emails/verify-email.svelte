<script lang="ts">
	...
	let { userName = null, verificationUrl }: Props = $props();
</script>

<Html>
	<Head />
	<Body class="bg-gray-950 font-sans">
		<Preview preview="Verify your Ultramarine Server email" />
		<Container class="mx-auto my-8 max-w-xl [border-radius:0] border border-gray-800 bg-gray-900">
			...
			<Section class="p-8">
				...
				<Text class="mt-2 text-sm leading-5 text-gray-400">
					Please verify this email address for your Ultramarine Server account.
				</Text>
				<Section class="mt-6">
					<Button
				...
				<Text class="text-sm leading-5 text-gray-500">
					If you did not request this email verification, contact support@ultramarine-linux.org.
				</Text>
