...
<Html>
	...
	<Body class="bg-gray-950 font-sans">
		<Preview preview="Confirm your Ultramarine Server password change" />
		<Container class="mx-auto my-8 max-w-xl [border-radius:0] border border-gray-800 bg-gray-900">
			...
			<Section class="p-8">
				...
				<Text class="mt-2 text-sm leading-5 text-gray-400">
					Enter this code in Ultramarine Server to finish changing your password.
				</Text>
				...
				<Text class="text-sm leading-5 text-gray-500">
					...
					contact support@ultramarine-linux.org.
				</Text>
			</Section>
		</Container>
	</Body>
