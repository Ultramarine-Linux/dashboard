...
export type RuntimeEnv = {
	...
	TETRA_ENROLLMENT_TOKEN_FILE?: string;
	TETRA_TLS_CA_CERTIFICATE_FILE?: string;
	TETRA_LOCAL_ENDPOINTS?: string;
};
...
export function getRuntimeEnv(): RuntimeEnv {
	return {
		...
		TETRA_ENROLLMENT_TOKEN_FILE: privateEnv.TETRA_ENROLLMENT_TOKEN_FILE,
		TETRA_TLS_CA_CERTIFICATE_FILE: privateEnv.TETRA_TLS_CA_CERTIFICATE_FILE,
		TETRA_LOCAL_ENDPOINTS: privateEnv.TETRA_LOCAL_ENDPOINTS
	};
}
